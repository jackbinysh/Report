...
\usepackage[font=small,labelfont = sf, textfont=sf,labelfont=bf]{caption}
...
\todo[inline]{need a description about the terms representing clpX degradation.}
...
\begin{figure*}
    ...
    \centering
        \includegraphics[scale = 0.27, clip = true, trim = 120 0 125 0]{13_9_hist}
    ...
    \centering
        \includegraphics[scale = 0.3,clip = true, trim = 120 0 125 0]{14_7_hist}
